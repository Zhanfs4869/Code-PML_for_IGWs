"""
This is the script used to compute the effectiveness of PML for different values of A 
when Dz=0.025, corresponding to Fig. 2
"""
...
om_list = np.linspace(np.log10(0.05), np.log10(0.99), num=1001, endpoint=True)
om_list = 10**(om_list)
om = om_list[i]
