"""
This is the script used to evaluate how the effectiveness of Rayleigh damping varies with Dz 
when A=5, corresponding to Fig. 4(b) in the paper.
"""
...
om_list = np.linspace(np.log10(0.05), np.log10(0.5), num=501, endpoint=True)
om_list = 10**(om_list)
om = om_list[i]
print(om)

A = 5
Dz = 0.05 # Choice of Dz
# Dz = 0.07
# Dz = 0.09
